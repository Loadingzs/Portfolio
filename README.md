...
[🚀 Demo](#-demonstração) • [📋 Features](#-features) • [⚙️ Instalação](#️-instalação) • [🏗️ Estrutura](#️-estrutura-do-projeto)
...
<div align="center">
  <img src="https://img.shields.io/badge/Desempenho-🚀%20Otimizado-brightgreen" alt="Performance">
  <img src="https://img.shields.io/badge/Responsivo-📱%20💻%20🖥️-blue" alt="Responsivo">
  <img src="https://img.shields.io/badge/Tema%20Escuro/Azul-🌙%20☀️-purple" alt="Tema Dark/Blue">
  <img src="https://img.shields.io/badge/Acessibilidade-♿%20WCAG-yellow" alt="Acessível">
</div>
...
### Desktop (Tema Claro)
![Desktop Light Theme](https://imgur.com/a/Dw6oxFT)

### Mobile (Tema Escuro)
![Mobile Dark Theme](https://imgur.com/a/B54QJUl)
...
4. **Portfólio** - Projetos com filtro por categoria
5. **Experiência** - Linha do tempo profissional
6. **Contato** - Formulário com validação
...
### **Backend**
- ![Flask](https://img.shields.io/badge/Flask-2.3.3-000000?logo=flask) - Microframework web leve e poderoso
- ![Python](https://img.shields.io/badge/Python-3.8%2B-3776AB?logo=python) - Linguagem principal do backend

### **Frontend**
- ![HTML5](https://img.shields.io/badge/HTML5-E34F26?logo=html5) - Estrutura semântica do projeto
- ![CSS3](https://img.shields.io/badge/CSS3-1572B6?logo=css3) - Estilos avançados com variáveis e animações
- ![JavaScript](https://img.shields.io/badge/JavaScript-ES6%2B-F7DF1E?logo=javascript) - Interatividade e lógica do cliente

### **Bibliotecas & APIs**
- ![Font Awesome](https://img.shields.io/badge/Font_Awesome-6.4.0-528DD7?logo=font-awesome) - Ícones vetoriais
- ![Google Fonts](https://img.shields.io/badge/Google_Fonts-Outfit+Sora-4285F4?logo=google-fonts) - Tipografia moderna
- ![Flask CORS](https://img.shields.io/badge/Flask_CORS-4.0.0-lightgrey) - Controle de acesso entre origens
...
1. **Altere a chave secreta** no `app.py`:
```python
...
4. **Use um servidor de produção** (WSGI):
```python
...
- GitHub: [@Loadingzs](https://github.com/Loadingzs)
- LinkedIn: [maykondias](https://linkedin.com/in/maykondias)
...
[![GitHub stars](https://img.shields.io/github/stars/Loadingzs/Portfolio?style=social)](https://github.com/Loadingzs/Portfolio/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/Loadingzs/Portfolio?style=social)](https://github.com/Loadingzs/Portfolio/network/members)
